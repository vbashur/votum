...
public class HibernateRestaurantRepositoryTests {
	...
	public void testFindRestaurantByMerchantNumber() {
		...
		assertEquals("the benefitPercentage is wrong", restaurant.getBenefitPercentage(), Percentage.valueOf("8%"));
		assertEquals("the benefit availability policy is wrong", BenefitAvailabilityPolicy.ALWAYS_AVAILABLE, restaurant
